    ...
    async with pool.acquire() as conn:
        ...
        await conn.execute("""
            CREATE TABLE IF NOT EXISTS messages (
                ...
                source_code TEXT,
                user_message_id BIGINT NOT NULL,      -- userning original xabar id'si (userning chatida)
                owner_message_id BIGINT,                -- owner chatida yaratilgan xabar id'si
                content_preview TEXT,                   -- qidiruv/stat uchun qisqa matn
